...
export default function Generator(props) {
    ...
    return (
        <SectionWrapper id={'generate'}  title={['GENERATE', 'your', 'WORKOUT']}>
            <Header index={'01'} title={'Pick your Workout Type'} description={"Select the workout you wish to endure."} />
            ...
            <Header index={'02'} title={'Lock on targets'} description={"Select the muscle group to train."} />
            ...
            <Header index={'03'} title={'Goal & Objective'} description={"Select your ultimate objective."} />
